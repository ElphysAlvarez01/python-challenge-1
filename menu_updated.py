        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_item_number.isdigit():
                ...
                if menu_item_number in menu_items.keys():
                    ...
                    quantity = input(f"How many {item_name} would like to order?")
                ...
                print("Not a valid a menu option.")
        else:
            # Tell the customer they didn't select a menu option
...
for item in order:
    ...
    num_item_spaces = 20 - len(item_name)
...
totals = [item["Quantity"] * item["Price"] for item in order]
# and print the prices.
total = sum(totals)
print(f"Your receipt total is: {item_name}")